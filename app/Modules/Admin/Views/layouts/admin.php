...
<head>
    ...
    <title> <?= isset($page_title) ? esc( $page_title ) : esc( 'Quản Lý In' ); ?></title>

    <!-- Custom fonts for this template-->
    <link href="<?= base_url('assets/bsadmin') ?>/plugins/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top" class="admin-template">
    ...
    <script src="<?= base_url('assets/bsadmin') ?>/plugins/jquery/jquery.min.js"></script>
    <script src="<?= base_url('assets/bsadmin') ?>/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="<?= base_url('assets/bsadmin') ?>/plugins/jquery-easing/jquery.easing.min.js"></script>
